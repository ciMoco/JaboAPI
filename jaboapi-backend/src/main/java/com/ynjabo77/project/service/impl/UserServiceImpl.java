...
import com.ynjabo77.project.model.dto.user.UserQueryRequest;
import com.ynjabo77.project.model.enums.UserRoleEnum;
...
import com.ynjabo77.project.utils.SqlUtils;
...
import static com.ynjabo77.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = " ynjabo77";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 计算新用户序列号
            long userSerialNumber = this.baseMapper.selectCount(null) + 1;
            String BaoZi = "小宝子" + userSerialNumber + "号";
            // 2. 加密
            ...
            user.setLeftNum(10);
            user.setUserAvatar("https://vip.helloimg.com/i/2024/07/01/668200734322a.png");
            LocalDate yesterday = LocalDate.now().minusDays(1); // 获取昨天日期
            LocalDateTime yesterdayTime = yesterday.atStartOfDay(); // 获取昨天的0点时间
            Date yesterdatDate = Date.from(yesterdayTime.atZone(ZoneId.systemDefault()).toInstant()); // 转换为Date类型
            user.setSignDate(yesterdatDate);
